...
public class GirisDoktor extends javax.swing.JFrame {
    ...
    public ArrayList<Doktorlar> getDoktorlar() throws SQLException{
        Connection connection=null;
        DbHelper dbHelper =new DbHelper();
        Statement statement =null;
        ResultSet resultSet;
        ArrayList<Doktorlar> doktorlar=null;
        
        try{
            connection = dbHelper.getConnection();
            statement=connection.createStatement();
            resultSet=statement.executeQuery("select * from kisiler where Degree = 'Doktor' ");
            doktorlar =new ArrayList<Doktorlar>();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Doktor Giriş Sayfası");
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        int a =0;      
        try{
            ArrayList<Doktorlar> doktorlar = getDoktorlar();
            for(Doktorlar doktor : doktorlar){       
                if(doktor.getId().equals(tbxId.getText())){  
                    if(doktor.getPassword().equals(String.valueOf(tbxPassword.getPassword()))){
                        a=1;
                        setVisible(false);
