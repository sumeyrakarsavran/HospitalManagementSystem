...
public class GirisVatandas extends javax.swing.JFrame {
    
    public GirisVatandas() {
        initComponents();
    ...
    public ArrayList<Vatandaslar> getVatandaslar() throws SQLException{
        Connection connection=null;
        DbHelper dbHelper =new DbHelper();
        Statement statement =null;
        ResultSet resultSet;
        ArrayList<Vatandaslar> vatandaslar=null;
        
        try{
            connection = dbHelper.getConnection();
            statement=connection.createStatement();
            resultSet=statement.executeQuery("select * from kisiler where Degree = 'Vatandas' ");
            vatandaslar =new ArrayList<Vatandaslar>();
            
            while(resultSet.next()){
                vatandaslar.add(new Vatandaslar(
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Vatandaş Giriş Sayfası");
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            ArrayList<Vatandaslar> vatandaslar = getVatandaslar();
            for(Vatandaslar v : vatandaslar){       
                if(v.getId().equals(tbxId.getText())){  
                    if(v.getPassword().equals(String.valueOf(tbxPassword.getPassword()))){
                        a=1;
                        setTc("b");
                        getTc();
                        setPassword(String.valueOf(tbxPassword.getPassword()));
